...
public final class GameInstaller {
    ...
    public List<String> command(Installation installation,MicrosoftAuth.Session session,int ram,String java) throws Exception {
        ...
        v.put("user_type","msa");v.put("version_type","Tar Client");v.put("natives_directory",installation.natives().toString());v.put("launcher_name","TarClient");v.put("launcher_version","0.1.0");
